			...
			{		
				...
				switch(frame)
				{
					...
					case MAV_FRAME_GLOBAL:
					{
						...
						{
							if( isvalid(params[6]) == false )	//高度不正确不移动高度
								res = Position_Control_set_TargetPositionXYZRelative_LatLon( params[4], params[5], 0, vel );
							else
					...
					case MAV_FRAME_LOCAL_NED:
						...
						{
							Position_Control_set_ZLock();
							res = Position_Control_set_TargetPositionXY( params[5]*100, params[4]*100, vel );
						}
						else
					...
					case MAV_FRAME_LOCAL_ENU:
						...
						{
							Position_Control_set_ZLock();
							res = Position_Control_set_TargetPositionXY( params[4]*100, params[5]*100, vel );
						}
						else
					...
					case MAV_FRAME_LOCAL_OFFSET_NED:
						...
						{
							Position_Control_set_ZLock();
							res = Position_Control_set_TargetPositionXYRelative( params[5]*100, params[4]*100, vel );
						}
						else
					...
					case MAV_FRAME_BODY_OFFSET_NED:
					{
						...
						if( isvalid(params[3]) == false )
						{
							...
							{
								Position_Control_set_ZLock();
								res = Position_Control_set_TargetPositionXYRelativeBodyheading( safe_sqrt(params[5]*params[5] + params[4]*params[4])*100, 0, vel );
							}
							else
						...
						else
						{
							...
							{
								Position_Control_set_ZLock();
								res = Position_Control_set_TargetPositionXYRelativeBodyheading( params[5]*100, params[4]*100, vel );
							}
							else
					...
					case MAV_FRAME_BODY_FLU:
					{
						...
						if( isvalid(params[3]) == false )
						{
							...
							{
								Position_Control_set_ZLock();
								res = Position_Control_set_TargetPositionXYRelativeBodyheading( safe_sqrt(params[4]*params[4] + params[5]*params[5])*100, 0, vel );
							}
							else
						...
						else
						{
							...
							{
								Position_Control_set_ZLock();
								res = Position_Control_set_TargetPositionXYRelativeBodyheading( params[4]*100, params[5]*100, vel );
							}
							else
