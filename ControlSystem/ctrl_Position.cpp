...
//		target_acceleration.y = TAcc.y - WindDisturbance.y;
		...
		double logbuf[10];
		logbuf[0] = WindDisturbance.x;
		logbuf[1] = T3.x;
		logbuf[2] = target_acceleration.x;
		logbuf[3] = WindDisturbance.y;
		logbuf[4] = T3.y;
		logbuf[5] = target_acceleration.y;
		SDLog_Msg_DebugVect( "wind", logbuf, 6 );
